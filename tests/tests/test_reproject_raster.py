...
class TestReprojectRaster:
    ...
    def test_raster_already_in_3857(self, input_dir: Path, output_dir: Path, working_dir: Path) -> None:
        ...
        with pytest.raises(ValueError, match="The raster is already projected to EPSG: 3857"):
            reproject_raster(input_path=input_path, output_path=output_path, epsg_code=3857)
